...
*/
ssize_t set_proximity_gp2ap110s_avg_raw_data(struct ssp_data *data,
                                           const char *buf)
{
	char chTempbuf[8] = { 0, };
	int ret;
...
ssize_t set_proximity_gp2ap110s_calibration(struct ssp_data *data, const char *buf)
{
	int ret;
	u8 temp;
...
ssize_t get_proximity_gp2ap110s_calibration_result(char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%d\n", 1);
}
...
struct proximity_sensor_operations prox_gp2ap110s_ops = {
	...
	.set_proximity_calibration = set_proximity_gp2ap110s_calibration,
	.get_proximity_calibration_result = get_proximity_gp2ap110s_calibration_result,
};

struct proximity_sensor_operations* get_proximity_gp2ap110s_function_pointer(
